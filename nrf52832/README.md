...
For nrf52832, there are several widely used UF2 bootloaders, they require slight different configs.
...
Model: nice!nano
Board-ID: nrf52832-nicenano
SoftDevice: S140 version 6.1.1
Date: Jun 19 2021
```

As you can see, the version of softdevice is `S140 version 6.1.1`. For nrf52832, RMK supports S140 version 6.X and 7.X. The `memory.x` config is slightly different for softdevice 6.X and 7.X:

```ld
MEMORY
{
  /* These values correspond to the nrf52832 with Softdevices S140 6.1.1 */
  /* FLASH : ORIGIN = 0x00026000, LENGTH = 824K */

  /* These values correspond to the nrf52832 with Softdevices S140 7.3.0 */
